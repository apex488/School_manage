...
<section class="section">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <img class="img-fluid w-100 mb-4" src="user/images/about/about-page.jpg" alt="about image">
...
<!-- success story -->
<section class="section bg-cover mb-5" data-background="user/images/backgrounds/success-story.jpg">
  <div class="container">
    <div class="row">
