...
<!-- /blog -->
 ...
 @section('userbanner')
     <!-- hero slider -->
<section class="hero-section overlay bg-cover" data-background="user/images/banner/banner-1.jpg">
  <div class="container">
  ...
  <div class="container-fluid p-0">
    <div class="row no-gutters">
      <div class="col-xl-4 col-lg-5 align-self-end">
        <img class="img-fluid w-100" src="user/images/banner/banner-feature.png" alt="banner-feature">
      </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
        <img class="img-fluid w-100" src="user/images/about/about-us.jpg" alt="about image">
      </div>
    </div>
  </div>
</section>
...
<!-- success story -->
<section class="section bg-cover" data-background="user/images/backgrounds/success-story.jpg">
  <div class="container">
    <div class="row">
