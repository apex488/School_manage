              ...
              <div class="card overflow-hidden">
                <div class="card-body pb-0">
                  ...
                  <div class="mt-4 pb-3 d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-0 fw-bolder fs-4">Total Users</h5>
                      
                    </div>
                    <div class="ms-auto">
                      <span class="badge bg-secondary-subtle text-muted">{{$user}}</span>
                    </div>
                  </div>
                  <div class="py-3 d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-0 fw-bolder fs-4">Upcoming Events</h5>
                      
                    </div>
                    <div class="ms-auto">
                      <span class="badge bg-secondary-subtle text-muted">{{$event}}</span>
                    </div>
                  </div>
                  <div class="py-3 d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-0 fw-bolder fs-4">Total Courses</h5>
                      
                    </div>
                    <div class="ms-auto">
                      <span class="badge bg-secondary-subtle text-muted">{{$course}}</span>
                    </div>
                  </div>
                  <div class="pt-3 mb-7 d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-0 fw-bolder fs-4">Total Contacts</h5>
                      
                    </div>
                    <div class="ms-auto">
                      <span class="badge bg-secondary-subtle text-muted">{{$contact}}</span>
                    </div>
                  </div>
                </div>
              </div>
